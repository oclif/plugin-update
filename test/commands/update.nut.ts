...
describe.skip('update', () => {
  skipIfWindows('tests the updater', async () => {
    ...
    /**
     * release a new version of the example app to s3
     * @param version
     */
    ...
    /**
     * verifies the plugin and node version is the expected value - via bin/run version
     * @param version
     * @param nodeVersion
     */
    ...
    /**
     * update plugin to default channel or the given channel - via ./bin/run update [channel]
     * @param channel
     */
