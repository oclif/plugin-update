...
@oclif/plugin-update/1.1.8 linux-x64 node-v8.11.1
...
_See code: [src/commands/update.ts](https://github.com/oclif/plugin-update/blob/v1.1.8/src/commands/update.ts)_
<!-- commandsstop -->
